...
import { useFetchCustomer, useFetchDiscount } from "../hooks";
import AutoCompleteProduct from "../../auto-complete/AutoCompleteProduct";
import { AdapterDayjs } from '@mui/x-date-pickers/AdapterDayjs';
import { LocalizationProvider } from '@mui/x-date-pickers/LocalizationProvider';
import { DatePicker } from '@mui/x-date-pickers/DatePicker';
import AutoCompleteCustomer from "../../auto-complete/AutoCompleteCustomer";
...
export const FormAddProductPageCustomer = (props: IProps) => {
  const {
    index,
    formBundle,
    remove,
  ...
  return (
    <>
      {index >= 1 ? (
        ...
        >
          <Button
            data-testid="customer-formaddproductpagecustomer-remove-button"
            variant="contained"
            color="error"
        ...
        <Box sx={{ display: "flex", flexWrap: "wrap", gap: "1rem" }}>
          ...
          {(formBundle.type === ProductMasterType.AUTO || formBundle.type === ProductMasterType.AUTO_PLAY) &&
            <>
              ...
              <TextField
                data-testid="customer-formaddproductpagecustomer-agent-id-text"
                sx={{ width: "48%" }}
              ...
              {formBundle.type !== ProductMasterType.AUTO_PLAY &&
                <TextField
                  data-testid="customer-formaddproductpagecustomer-clientname-text"
                  sx={{ width: "48%" }}
                  label={t("placeholder.client-name")}
                  type={"text"}
                  id="client-name"
          ...
          <NumericFormat
            data-testid="customer-formaddproductpagecustomer-deposit-text"
            sx={{ width: formBundle.type !== ProductMasterType.DIRECT_API ? "48%" : "98.7%" }}
            id="outlined-basic"
          ...
          {formBundle.type !== ProductMasterType.DIRECT_API &&
            <>
              <FormControl sx={{ width: formBundle.type === ProductMasterType.DIRECT_API || formBundle.type === ProductMasterType.AUTO_PLAY ? "48%" : "98.7%" }}>
                <InputLabel id="discount-checkbox-label">
                  {t("placeholder.discount")}
                </InputLabel>
                <Select
                  data-testid="customer-formaddproductpagecustomer-discount-select"
              ...
              {formBundle.type !== ProductMasterType.SPORT_BOOK_V2 &&
                <>
                  <FormControl sx={{ width: "45.3%" }}>
                    ...
                    <Select
                      data-testid="customer-formaddproductpagecustomer-currency-select"
                  ...
                  <FormControl sx={{ width: "45.3%" }}>
                    ...
                    <Select
                      data-testid="customer-formaddproductpagecustomer-crypto-select"
                      labelId="demo-simple-select-label"
                      id="demo-simple-select"
