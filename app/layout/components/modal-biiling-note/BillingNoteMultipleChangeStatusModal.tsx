...
export default function BillingNoteMultipleChangeStatusModal(props: ModalProps) {
    const { t } = useTranslation()
    const { updateMultipleStatus } = BillingService();
    const { TranslateErrorCode } = useTranslateErrorCode()
    const { alertError, alertSuccess } = useAlertDialog();
    const { openModal, closeModal, data, triggerHandleSearch, setTriggerHandleSearch, nextBillingStatus, currentBillingStatus, setSelectStatus } = props
