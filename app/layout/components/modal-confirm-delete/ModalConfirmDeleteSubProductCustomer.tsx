...
const createDataSubProducts = (sub_product: subProduct, prefix: string[], discount_product: discountProduct[],) => {
  return { sub_product, prefix, discount_product };
}

export const ModalConfirmDeleteSubProductCustomer = (props: any) => {
  const { title } = props
    ...
    >
      <Box>
        ...
        <Box sx={{ display: "flex", justifyContent: "flex-end", mt: "1.5rem" }}>
          <Button
            data-testid="globalcomponent-confirmsubproductcustomerdelete-cancel-button"
            variant="text"
            children="CANCEL"
          />
          <Button
            data-testid="globalcomponent-confirmsubproductcustomerdelete-agree-button"
            variant="text"
            children="AGREE"
            onClick={() => {
            }}
